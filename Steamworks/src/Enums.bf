...
{
	public enum ESteamIPType : int32
	{
		IPv4 = 0,
		IPv6 = 1,
	}

	public enum EUniverse : int32
	{
		Invalid = 0,
		Public = 1,
		Beta = 2,
	...
	public enum EVoiceResult : int32
	{
		OK = 0,
		NotInitialized = 1,
		NotRecording = 2,
	...
	public enum EBeginAuthSessionResult : int32
	{
		OK = 0,
		InvalidTicket = 1,
		DuplicateRequest = 2,
	...
	public enum EAuthSessionResponse : int32
	{
		OK = 0,
	...
	public enum EUserHasLicenseForAppResult : int32
	{
		ResultHasLicense = 0,
		ResultDoesNotHaveLicense = 1,
		ResultNoAuth = 2,
	}

	public enum EAccountType : int32
	{
		Invalid = 0,
		Individual = 1,
		Multiseat = 2,
	...
	public enum EAppReleaseState : int32
	{
		Unknown = 0,
		Unavailable = 1,
		Prerelease = 2,
	...
	public enum EAppOwnershipFlags : int32
	{
		None = 0,
		OwnsLicense = 1,
		FreeLicense = 2,
	...
	public enum ESteamUserStatType : int32
	{
		INVALID = 0,
		INT = 1,
		FLOAT = 2,
	...
	public enum EChatEntryType : int32
	{
		Invalid = 0,
		ChatMsg = 1,
		Typing = 2,
	...
	public enum EChatRoomEnterResponse : int32
	{
		Success = 1,
		DoesntExist = 2,
		NotAllowed = 3,
	...
	public enum ENotificationPosition : int32
	{
		TopLeft = 0,
		TopRight = 1,
		BottomLeft = 2,
	...
	public enum EBroadcastUploadResult : int32
	{
		None = 0,
		OK = 1,
		InitFailed = 2,
	...
	public enum ELaunchOptionType : int32
	{
		None = 0,
		Default = 1,
		SafeMode = 2,
	...
	public enum EVRHMDType : int32
	{
		...
		Huawei_Unknown = 120,
		Huawei_VR2 = 121,
		Huawei_EndOfRange = 129,
		Valve_Unknown = 130,
		Valve_Index = 131,
	}

	public enum EMarketNotAllowedReasonFlags : int32
	{
		None = 0,
		TemporaryFailure = 1,
		AccountDisabled = 2,
	...
	public enum EDurationControlProgress : int32
	{
		Full = 0,
		Half = 1,
		None = 2,
	...
	public enum EDurationControlNotification : int32
	{
		None = 0,
		_1Hour = 1,
		_3Hours = 2,
	...
	public enum EDurationControlOnlineState : int32
	{
		Invalid = 0,
		Offline = 1,
		Online = 2,
	...
	public enum EGameSearchErrorCode_t : int32
	{
		OK = 1,
	...
	public enum EPlayerResult_t : int32
	{
		FailedToConnect = 1,
		Abandoned = 2,
		Kicked = 3,
	...
	public enum ESteamIPv6ConnectivityProtocol : int32
	{
		Invalid = 0,
		HTTP = 1,
		UDP = 2,
	...
	public enum ESteamIPv6ConnectivityState : int32
	{
		Unknown = 0,
		Good = 1,
		Bad = 2,
	...
	public enum EFriendRelationship : int32
	{
		None = 0,
		Blocked = 1,
		RequestRecipient = 2,
	...
	public enum EUserRestriction : int32
	{
		None = 0,
		Unknown = 1,
		AnyChat = 2,
	...
	public enum EOverlayToStoreFlag : int32
	{
		None = 0,
		AddToCart = 1,
		AddToCartAndShow = 2,
	...
	public enum EActivateGameOverlayToWebPageMode : int32
	{
		Default = 0,
		Modal = 1,
	}

	public enum EPersonaChange : int32
	{
		Name = 1,
		Status = 2,
		ComeOnline = 4,
	...
	public enum ESteamAPICallFailure : int32
	{
		None = -1,
		SteamGone = 0,
		NetworkFailure = 1,
	...
	public enum EGamepadTextInputMode : int32
	{
		Normal = 0,
		Password = 1,
	}

	public enum EGamepadTextInputLineMode : int32
	{
		SingleLine = 0,
		MultipleLines = 1,
	}

	public enum ETextFilteringContext : int32
	{
		Unknown = 0,
		GameContent = 1,
		Chat = 2,
	...
	public enum ECheckFileSignature : int32
	{
		InvalidSignature = 0,
		ValidSignature = 1,
		FileNotFound = 2,
	...
	public enum EMatchMakingServerResponse : int32
	{
		Responded = 0,
		FailedToRespond = 1,
	...
	public enum ELobbyComparison : int32
	{
		EqualToOrLessThan = -2,
		LessThan = -1,
		Equal = 0,
	...
	public enum ELobbyDistanceFilter : int32
	{
		Close = 0,
		Default = 1,
		Far = 2,
	...
	public enum EChatMemberStateChange : int32
	{
		Entered = 1,
		Left = 2,
		Disconnected = 4,
	...
	public enum ESteamPartyBeaconLocationType : int32
	{
		Invalid = 0,
		ChatGroup = 1,
		Max = 2,
	...
	public enum ESteamPartyBeaconLocationData : int32
	{
		Invalid = 0,
		Name = 1,
		IconURLSmall = 2,
	...
	public enum ERemoteStoragePlatform : int32
	{
		None = 0,
		Windows = 1,
		OSX = 2,
	...
	public enum ERemoteStoragePublishedFileVisibility : int32
	{
		Public = 0,
		FriendsOnly = 1,
		Private = 2,
	...
	public enum EWorkshopFileType : int32
	{
		First = 0,
		Community = 0,
		Microtransaction = 1,
	...
	public enum EWorkshopVote : int32
	{
		Unvoted = 0,
		For = 1,
		Against = 2,
	...
	public enum EWorkshopFileAction : int32
	{
		Played = 0,
		Completed = 1,
	}

	public enum EWorkshopEnumerationType : int32
	{
		RankedByVote = 0,
		Recent = 1,
		Trending = 2,
	...
	public enum EWorkshopVideoProvider : int32
	{
		None = 0,
		Youtube = 1,
	}

	public enum EUGCReadAction : int32
	{
	...
	public enum ELeaderboardDataRequest : int32
	{
		Global = 0,
		GlobalAroundUser = 1,
		Friends = 2,
	...
	public enum ELeaderboardSortMethod : int32
	{
		None = 0,
		Ascending = 1,
		Descending = 2,
	...
	public enum ELeaderboardDisplayType : int32
	{
		None = 0,
		Numeric = 1,
		TimeSeconds = 2,
	...
	public enum ELeaderboardUploadScoreMethod : int32
	{
		None = 0,
		KeepBest = 1,
		ForceUpdate = 2,
	...
	public enum ERegisterActivationCodeResult : int32
	{
		OK = 0,
		Fail = 1,
		AlreadyRegistered = 2,
	...
	public enum EP2PSessionError : int32
	{
		None = 0,
		NoRightsToApp = 2,
		Timeout = 4,
	...
	public enum ESNetSocketState : int32
	{
		Invalid = 0,
		Connected = 1,
		Initiated = 10,
	...
	public enum ESNetSocketConnectionType : int32
	{
		NotConnected = 0,
		UDP = 1,
		UDPRelay = 2,
	...
	public enum EVRScreenshotType : int32
	{
		None = 0,
		Mono = 1,
		Stereo = 2,
	...
	public enum AudioPlayback_Status : int32
	{
		Undefined = 0,
		Playing = 1,
		Paused = 2,
	...
	public enum EHTTPStatusCode : int32
	{
		Invalid = 0,
		_100Continue = 100,
	...
	public enum EInputSourceMode : int32
	{
		None = 0,
		Dpad = 1,
		Buttons = 2,
	...
	public enum EInputActionOrigin : int32
	{
		None = 0,
		SteamController_A = 1,
		SteamController_B = 2,
	...
	public enum ESteamControllerPad : int32
	{
		Left = 0,
		Right = 1,
	}

	public enum ESteamInputType : int32
	{
		Unknown = 0,
		SteamController = 1,
		XBox360Controller = 2,
	...
	public enum ESteamInputLEDFlag : int32
	{
		SetColor = 0,
		RestoreUserDefault = 1,
	}

	public enum EControllerActionOrigin : int32
	{
		None = 0,
		A = 1,
		B = 2,
	...
	public enum ESteamControllerLEDFlag : int32
	{
		SetColor = 0,
		RestoreUserDefault = 1,
	}

	public enum EUGCMatchingUGCType : int32
	{
		Items = 0,
		Items_Mtx = 1,
		Items_ReadyToUse = 2,
	...
	public enum EUserUGCList : int32
	{
		Published = 0,
		VotedOn = 1,
		VotedUp = 2,
	...
	public enum EUserUGCListSortOrder : int32
	{
		CreationOrderDesc = 0,
		CreationOrderAsc = 1,
		TitleAsc = 2,
	...
	public enum EItemUpdateStatus : int32
	{
		Invalid = 0,
		PreparingConfig = 1,
		PreparingContent = 2,
	...
	public enum EItemStatistic : int32
	{
		NumSubscriptions = 0,
		NumFavorites = 1,
		NumFollowers = 2,
	...
	public enum EItemPreviewType : int32
	{
		Image = 0,
		YouTubeVideo = 1,
		Sketchfab = 2,
	...
	public enum ESteamItemFlags : int32
	{
		NoTrade = 1,
		Removed = 256,
		Consumed = 512,
	...
	public enum EParentalFeature : int32
	{
		Invalid = 0,
		Store = 1,
		Community = 2,
	...
	public enum ESteamDeviceFormFactor : int32
	{
		Unknown = 0,
		Phone = 1,
		Tablet = 2,
	...
	public enum ESteamNetworkingAvailability : int32
	{
		CannotTry = -102,
		Failed = -101,
		Previously = -100,
	...
	public enum ESteamNetConnectionEnd : int32
	{
		Invalid = 0,
		App_Min = 1000,
		App_Generic = 1000,
	...
	public enum ESteamNetTransportKind : int32
	{
		Unknown = 0,
		LoopbackBuffers = 1,
		LocalHost = 2,
	...
	public enum ESteamNetworkingConfigScope : int32
	{
		Global = 1,
		SocketsInterface = 2,
		ListenSocket = 3,
	...
	public enum ESteamNetworkingConfigDataType : int32
	{
		Int32 = 1,
		Int64 = 2,
		Float = 3,
	...
	public enum ESteamNetworkingConfigValue : int32
	{
		Invalid = 0,
	...
	public enum ESteamNetworkingGetConfigValueResult : int32
	{
		BadValue = -1,
		BadScopeObj = -2,
		BufferTooSmall = -3,
	...
	public enum ESteamNetworkingSocketsDebugOutputType : int32
	{
		None = 0,
		Bug = 1,
		Error = 2,
